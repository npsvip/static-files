...
var SDData = [
    ...
    [{name: '济南'}, {name: '杭州', value: 95}],
    [{name: '济南'}, {name: '北海', value: 20}],
    [{name: '济南'}, {name: '南宁', value: 70}],
    [{name: '济南'}, {name: '合肥', value: 100}],
    [{name: '济南'}, {name: '武汉', value: 110}],
...
var XGData = [
    ...
    [{name: '香港'}, {name: '广州', value: 90}],
    [{name: '香港'}, {name: '长沙', value: 40}],
...
var series = [];
[['成都', SCData], ['济南', SDData], ['香港', XGData]].forEach(function (item, i) {
    series.push({
            name: item[0],
            type: 'lines',
            zlevel: 1,
